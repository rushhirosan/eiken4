...
INSTALLED_APPS = [
    ...
    # runserver 時は Django 標準の静的配信の代わりに WhiteNoise を使う（HTML5 audio の Range 対応など）
...
MIDDLEWARE = [
    ...
    'eiken_project.middleware.CanonicalHostRedirectMiddleware',
...
PUBLIC_BASE_URL = os.environ.get('PUBLIC_BASE_URL', 'https://eigogohan.com').rstrip('/')
