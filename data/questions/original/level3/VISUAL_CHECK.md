...
| 種類 | 配置 | 状態メモ |
|------|------|----------|
| 音声 Part1 | `static/audio/level3/part1/listening_illustration_question{1–10}.mp3` | TTS 済（+0%） |
| 音声 Part2 | `static/audio/level3/part2/listening_conversation_question{1–5}.mp3` | TTS 済 |
| 音声 Part3 | `static/audio/level3/part3/listening_passage_question{1–5}.mp3` | TTS 済 |
...
- [ ] 会話の状況と矛盾しないか（特に **image2** はポスターよりフォルダ寄りになりやすい）
- [ ] 白黒教育線画として違和感がないか
