...
本番大問1は **3択・選択肢読み上げ**。短い会話のあとに、イラスト上の 1/2/3 に対応する応答。
...
- 5級現行公開: Part1 **No.1–15**、Part3 **No.101–110**（本番は第1部10・第3部10）。追記するとき Part1 は連続番号、Part3 は 101 以上
- 4級・3級現行公開は各 **10問**（本番 L 大問1 と同数）。話者は `M:` / `W:`。**画像は会話の最後の状況と一致**させる（床に落ちたびん、改札と定期など、テキストと絵が食い違わないこと）
- 音声・画像は自作／TTS／新規生成のみ。プレースホルダー（ラベルだけの画像）は置かない
- 5級 TTS は既定 **-15%**
