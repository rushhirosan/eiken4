...
class Command(BaseCommand):
    help = 'listening_passage_questions.txt から問題21-30の文章問題を登録する'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING('既存のリスニング文章問題（21-30）を削除しました'))
        ...
        self.stdout.write(self.style.SUCCESS('問題21-30のリスニング文章問題を登録しました'))
